        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-6">
          ...
          <div className="lg:col-span-4">
            ...
            <p className="text-sm text-white/60 leading-relaxed mb-5 max-w-xs">
              ...
              ngũ xe lớn nhất bao gồm đa dạng các dòng xe từ xe đời mới chạy ít km, xe tiết kiệm cho
              đến xe thương mại. Chúng tôi luôn sẵn sàng phục vụ và cung cấp dịch vụ trên toàn lãnh
              thổ Việt Nam.
            </p>
              ...
              <ul className="space-y-2.5">
                {items.map(({ label, to }) => (
                  <li key={to}>
                    <Link
                      to={to}
                      className="text-sm text-white/60 hover:text-brand-accent transition"
                    >
                      {label}
                    </Link>
                  </li>
