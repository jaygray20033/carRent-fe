...
export default function CarListPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8">
      ...
      <p className="mt-1 text-sm text-gray-500">{data?.meta?.total ?? 0} xe sẵn sàng cho thuê</p>
      ...
      <div className="mt-6">
        {isLoading ? (
          ...
          <EmptyState title="Không tìm thấy xe" description="Hãy thử thay đổi điều kiện lọc." />
        ) : (
